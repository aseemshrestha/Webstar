										...
										<div class="widget">
											<div class="card z-depth-2-top">
												...
												<c:forEach var="recent" items="${recentPosts}" varStatus="position">
													<div class="card-body">
														<medium> <strong>${ recent.userDetails.firstName}
															${ recent.userDetails.lastName}</strong> <small>${recent.timeLapse}</small>
														...
														<p class="mb-4">
															...
															<div class="col-8">
																<ul class="inline-links inline-links--style-3">
																	...
																	<li><a href="javascript:void(0)"><i class="fa fa-comment" onclick="ThreadWidget.buildCommentWindow(event);"></i> 750</a></li>
