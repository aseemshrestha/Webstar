...
<div class="body-wrap" data-template-mode="cards">
 <div id="st-container" class="st-container"> <jsp:include page="_profileimage.jsp" /> <div class="st-pusher">
	<div class="st-content">
		<div class="st-content-inner">
			<jsp:include page="_search.jsp" /> <section class="slice sct-color-2" style="padding-top: 1em; padding-bottom: 1em;!important">
				<div class="profile"><div class="container"><div class="row cols-md-space cols-sm-space cols-xs-space">
					<jsp:include page="_leftcolumn.jsp" /> <div class="col-lg-6" id="contents-div"><div class="widget"><div class="card z-depth-2-top">
					  <jsp:include page="_tabs.jsp" /><c:forEach var="recent" items="${categoriescomments}" varStatus="position">
